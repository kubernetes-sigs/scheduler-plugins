...
cp -r data bootstrap/content/data
...
echo "Move bootstrap files to bootstrap/ and set permissions..."
...
# 7) Copy the built binary from "bin/kube-scheduler" to "bootstrap/content/bin" folder
echo "Copying built kube-scheduler binary into bootstrap/content/bin..."
