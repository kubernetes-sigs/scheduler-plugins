...
###############################################################
KWOK_CLUSTER_NAME="${KWOK_CLUSTER_NAME:-kwok1}"
...
export KWOK_CLUSTER_NAME=${KWOK_CLUSTER_NAME}
...
echo "[init] wrote ${KWOKRC}: cluster=${KWOK_CLUSTER_NAME} configs=${KWOK_CONFIGS} seeds=${KWOK_SEEDS} runtime=${KWOK_RUNTIME}"
