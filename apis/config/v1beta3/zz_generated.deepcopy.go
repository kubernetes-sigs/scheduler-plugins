...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZoneResourceArgs) DeepCopyInto(out *ZoneResourceArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.PriorityZones != nil {
		in, out := &in.PriorityZones, &out.PriorityZones
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZoneResourceArgs.
func (in *ZoneResourceArgs) DeepCopy() *ZoneResourceArgs {
	if in == nil {
		return nil
	}
	out := new(ZoneResourceArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ZoneResourceArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
