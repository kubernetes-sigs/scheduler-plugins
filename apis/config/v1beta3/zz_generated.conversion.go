...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ZoneResourceArgs)(nil), (*config.ZoneResourceArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_ZoneResourceArgs_To_config_ZoneResourceArgs(a.(*ZoneResourceArgs), b.(*config.ZoneResourceArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ZoneResourceArgs)(nil), (*ZoneResourceArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ZoneResourceArgs_To_v1beta3_ZoneResourceArgs(a.(*config.ZoneResourceArgs), b.(*ZoneResourceArgs), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1beta3_ZoneResourceArgs_To_config_ZoneResourceArgs(in *ZoneResourceArgs, out *config.ZoneResourceArgs, s conversion.Scope) error {
	out.ZoneLabel = in.ZoneLabel
	out.PriorityZones = *(*[]string)(unsafe.Pointer(&in.PriorityZones))
	out.ResourceNamespace = in.ResourceNamespace
	out.CleanupInterval = in.CleanupInterval
	return nil
}

// Convert_v1beta3_ZoneResourceArgs_To_config_ZoneResourceArgs is an autogenerated conversion function.
func Convert_v1beta3_ZoneResourceArgs_To_config_ZoneResourceArgs(in *ZoneResourceArgs, out *config.ZoneResourceArgs, s conversion.Scope) error {
	return autoConvert_v1beta3_ZoneResourceArgs_To_config_ZoneResourceArgs(in, out, s)
}

func autoConvert_config_ZoneResourceArgs_To_v1beta3_ZoneResourceArgs(in *config.ZoneResourceArgs, out *ZoneResourceArgs, s conversion.Scope) error {
	out.ZoneLabel = in.ZoneLabel
	out.PriorityZones = *(*[]string)(unsafe.Pointer(&in.PriorityZones))
	out.ResourceNamespace = in.ResourceNamespace
	out.CleanupInterval = in.CleanupInterval
...
// Convert_config_ZoneResourceArgs_To_v1beta3_ZoneResourceArgs is an autogenerated conversion function.
func Convert_config_ZoneResourceArgs_To_v1beta3_ZoneResourceArgs(in *config.ZoneResourceArgs, out *ZoneResourceArgs, s conversion.Scope) error {
	return autoConvert_config_ZoneResourceArgs_To_v1beta3_ZoneResourceArgs(in, out, s)
}
