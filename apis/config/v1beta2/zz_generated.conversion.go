...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ReclaimIdleResourceArgs)(nil), (*config.ReclaimIdleResourceArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_ReclaimIdleResourceArgs_To_config_ReclaimIdleResourceArgs(a.(*ReclaimIdleResourceArgs), b.(*config.ReclaimIdleResourceArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ReclaimIdleResourceArgs)(nil), (*ReclaimIdleResourceArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ReclaimIdleResourceArgs_To_v1beta2_ReclaimIdleResourceArgs(a.(*config.ReclaimIdleResourceArgs), b.(*ReclaimIdleResourceArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_ReclaimIdleResourceArgs_To_config_ReclaimIdleResourceArgs(in *ReclaimIdleResourceArgs, out *config.ReclaimIdleResourceArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_int32_To_int32(&in.MinCandidateNodesPercentage, &out.MinCandidateNodesPercentage, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_int32_To_int32(&in.MinCandidateNodesAbsolute, &out.MinCandidateNodesAbsolute, s); err != nil {
...
// Convert_v1beta2_ReclaimIdleResourceArgs_To_config_ReclaimIdleResourceArgs is an autogenerated conversion function.
func Convert_v1beta2_ReclaimIdleResourceArgs_To_config_ReclaimIdleResourceArgs(in *ReclaimIdleResourceArgs, out *config.ReclaimIdleResourceArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_ReclaimIdleResourceArgs_To_config_ReclaimIdleResourceArgs(in, out, s)
}

func autoConvert_config_ReclaimIdleResourceArgs_To_v1beta2_ReclaimIdleResourceArgs(in *config.ReclaimIdleResourceArgs, out *ReclaimIdleResourceArgs, s conversion.Scope) error {
	if err := v1.Convert_int32_To_Pointer_int32(&in.MinCandidateNodesPercentage, &out.MinCandidateNodesPercentage, s); err != nil {
		return err
	}
	if err := v1.Convert_int32_To_Pointer_int32(&in.MinCandidateNodesAbsolute, &out.MinCandidateNodesAbsolute, s); err != nil {
...
// Convert_config_ReclaimIdleResourceArgs_To_v1beta2_ReclaimIdleResourceArgs is an autogenerated conversion function.
func Convert_config_ReclaimIdleResourceArgs_To_v1beta2_ReclaimIdleResourceArgs(in *config.ReclaimIdleResourceArgs, out *ReclaimIdleResourceArgs, s conversion.Scope) error {
	return autoConvert_config_ReclaimIdleResourceArgs_To_v1beta2_ReclaimIdleResourceArgs(in, out, s)
}
