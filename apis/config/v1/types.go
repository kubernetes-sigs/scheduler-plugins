...
type HighLoadFilterMetricProviderSpec struct {
	Type               HighLoadFilterMetricProviderType `json:"type,omitempty"`
	Address            string                           `json:"address,omitempty"`
	Token              string                           `json:"token,omitempty"`
	InsecureSkipVerify *bool                            `json:"insecureSkipVerify,omitempty"`
}
...
type HighLoadFilterArgs struct {
	...
	MetricProvider HighLoadFilterMetricProviderSpec `json:"metricProvider,omitempty"`
	...
	// these percentages.
	UsageThresholds HighLoadFilterUsageThresholds `json:"usageThresholds,omitempty"`
