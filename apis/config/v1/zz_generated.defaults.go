...
func RegisterDefaults(scheme *runtime.Scheme) error {
	...
	scheme.AddTypeDefaultingFunc(&HighLoadFilterArgs{}, func(obj interface{}) { SetObjectDefaults_HighLoadFilterArgs(obj.(*HighLoadFilterArgs)) })
...
func SetObjectDefaults_HighLoadFilterArgs(in *HighLoadFilterArgs) {
	SetDefaults_HighLoadFilterArgs(in)
}
