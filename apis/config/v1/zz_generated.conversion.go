...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HighLoadFilterArgs)(nil), (*config.HighLoadFilterArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HighLoadFilterArgs_To_config_HighLoadFilterArgs(a.(*HighLoadFilterArgs), b.(*config.HighLoadFilterArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.HighLoadFilterArgs)(nil), (*HighLoadFilterArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_HighLoadFilterArgs_To_v1_HighLoadFilterArgs(a.(*config.HighLoadFilterArgs), b.(*HighLoadFilterArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HighLoadFilterMetricProviderSpec)(nil), (*config.HighLoadFilterMetricProviderSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec(a.(*HighLoadFilterMetricProviderSpec), b.(*config.HighLoadFilterMetricProviderSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.HighLoadFilterMetricProviderSpec)(nil), (*HighLoadFilterMetricProviderSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec(a.(*config.HighLoadFilterMetricProviderSpec), b.(*HighLoadFilterMetricProviderSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HighLoadFilterUsageThresholds)(nil), (*config.HighLoadFilterUsageThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds(a.(*HighLoadFilterUsageThresholds), b.(*config.HighLoadFilterUsageThresholds), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.HighLoadFilterUsageThresholds)(nil), (*HighLoadFilterUsageThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds(a.(*config.HighLoadFilterUsageThresholds), b.(*HighLoadFilterUsageThresholds), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_HighLoadFilterArgs_To_config_HighLoadFilterArgs(in *HighLoadFilterArgs, out *config.HighLoadFilterArgs, s conversion.Scope) error {
	out.WatcherAddress = in.WatcherAddress
	if err := Convert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec(&in.MetricProvider, &out.MetricProvider, s); err != nil {
		return err
	}
	if err := Convert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds(&in.UsageThresholds, &out.UsageThresholds, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_bool_To_bool(&in.FailOpen, &out.FailOpen, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.MetricsUpdateIntervalSeconds, &out.MetricsUpdateIntervalSeconds, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.NodeMetricExpirationSeconds, &out.NodeMetricExpirationSeconds, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_HighLoadFilterArgs_To_config_HighLoadFilterArgs is an autogenerated conversion function.
func Convert_v1_HighLoadFilterArgs_To_config_HighLoadFilterArgs(in *HighLoadFilterArgs, out *config.HighLoadFilterArgs, s conversion.Scope) error {
	return autoConvert_v1_HighLoadFilterArgs_To_config_HighLoadFilterArgs(in, out, s)
}

func autoConvert_config_HighLoadFilterArgs_To_v1_HighLoadFilterArgs(in *config.HighLoadFilterArgs, out *HighLoadFilterArgs, s conversion.Scope) error {
	out.WatcherAddress = in.WatcherAddress
	if err := Convert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec(&in.MetricProvider, &out.MetricProvider, s); err != nil {
		return err
	}
	if err := Convert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds(&in.UsageThresholds, &out.UsageThresholds, s); err != nil {
		return err
	}
	if err := metav1.Convert_bool_To_Pointer_bool(&in.FailOpen, &out.FailOpen, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.MetricsUpdateIntervalSeconds, &out.MetricsUpdateIntervalSeconds, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.NodeMetricExpirationSeconds, &out.NodeMetricExpirationSeconds, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_HighLoadFilterArgs_To_v1_HighLoadFilterArgs is an autogenerated conversion function.
func Convert_config_HighLoadFilterArgs_To_v1_HighLoadFilterArgs(in *config.HighLoadFilterArgs, out *HighLoadFilterArgs, s conversion.Scope) error {
	return autoConvert_config_HighLoadFilterArgs_To_v1_HighLoadFilterArgs(in, out, s)
}

func autoConvert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec(in *HighLoadFilterMetricProviderSpec, out *config.HighLoadFilterMetricProviderSpec, s conversion.Scope) error {
	out.Type = config.HighLoadFilterMetricProviderType(in.Type)
...
// Convert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec is an autogenerated conversion function.
func Convert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec(in *HighLoadFilterMetricProviderSpec, out *config.HighLoadFilterMetricProviderSpec, s conversion.Scope) error {
	return autoConvert_v1_HighLoadFilterMetricProviderSpec_To_config_HighLoadFilterMetricProviderSpec(in, out, s)
}

func autoConvert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec(in *config.HighLoadFilterMetricProviderSpec, out *HighLoadFilterMetricProviderSpec, s conversion.Scope) error {
	out.Type = HighLoadFilterMetricProviderType(in.Type)
	out.Address = in.Address
	out.Token = in.Token
...
// Convert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec is an autogenerated conversion function.
func Convert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec(in *config.HighLoadFilterMetricProviderSpec, out *HighLoadFilterMetricProviderSpec, s conversion.Scope) error {
	return autoConvert_config_HighLoadFilterMetricProviderSpec_To_v1_HighLoadFilterMetricProviderSpec(in, out, s)
}

func autoConvert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds(in *HighLoadFilterUsageThresholds, out *config.HighLoadFilterUsageThresholds, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_int64_To_int64(&in.CPU, &out.CPU, s); err != nil {
		return err
	}
	if err := metav1.Convert_Pointer_int64_To_int64(&in.Memory, &out.Memory, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds is an autogenerated conversion function.
func Convert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds(in *HighLoadFilterUsageThresholds, out *config.HighLoadFilterUsageThresholds, s conversion.Scope) error {
	return autoConvert_v1_HighLoadFilterUsageThresholds_To_config_HighLoadFilterUsageThresholds(in, out, s)
}

func autoConvert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds(in *config.HighLoadFilterUsageThresholds, out *HighLoadFilterUsageThresholds, s conversion.Scope) error {
	if err := metav1.Convert_int64_To_Pointer_int64(&in.CPU, &out.CPU, s); err != nil {
		return err
	}
	if err := metav1.Convert_int64_To_Pointer_int64(&in.Memory, &out.Memory, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds is an autogenerated conversion function.
func Convert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds(in *config.HighLoadFilterUsageThresholds, out *HighLoadFilterUsageThresholds, s conversion.Scope) error {
	return autoConvert_config_HighLoadFilterUsageThresholds_To_v1_HighLoadFilterUsageThresholds(in, out, s)
}
