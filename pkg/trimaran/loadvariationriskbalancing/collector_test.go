...
var (
	args pluginConfig.LoadVariationRiskBalancingArgs = pluginConfig.LoadVariationRiskBalancingArgs{
		WatcherAddress:     "http://deadbeef:2020",
		SafeVarianceMargin: "1",
	}

	watcherResponse watcher.WatcherMetrics = watcher.WatcherMetrics{
