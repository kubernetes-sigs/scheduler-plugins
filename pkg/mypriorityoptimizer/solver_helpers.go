...
func (pl *MyPriorityOptimizer) isAnySolverEnabled() bool {
...
func (pl *MyPriorityOptimizer) buildSolverInput(
	nodes []*v1.Node,
	pods []*v1.Pod,
	preemptor *v1.Pod,
) (SolverInput, error) {
...
func (pl *MyPriorityOptimizer) planApplicable(out *SolverOutput, nodes []*v1.Node, pods []*v1.Pod) (bool, string) {
	if out == nil {
...
func (pl *MyPriorityOptimizer) exportSolverStatsConfigMap(
	ctx context.Context,
	strategy string,
	baseline *SolverScore,
	best string,
...
func (pl *MyPriorityOptimizer) appendSolverStatsCM(ctx context.Context, entry ExportedSolverStats) {
