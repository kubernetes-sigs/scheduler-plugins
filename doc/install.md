...
- [Install release v0.30.12 and use Coscheduling](#install-release-v03012-and-use-coscheduling)
...
## Install release v0.30.12 and use Coscheduling
...
1. Modify `/etc/kubernetes/manifests/kube-scheduler.yaml` to run scheduler-plugins with coscheduling
    ...
    -     - --leader-elect=true
    19,20c20
    +     image: registry.k8s.io/scheduler-plugins/kube-scheduler:v0.30.12
    ---
...
1. Verify that kube-scheduler pod is running properly with a correct image: `registry.k8s.io/scheduler-plugins/kube-scheduler:v0.30.12`
    ...
    registry.k8s.io/scheduler-plugins/kube-scheduler:v0.30.12
    ```
